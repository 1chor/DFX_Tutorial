...
#
# create_hw_project_new.tcl: Tcl script for re-creating project 'dfx_ip_cores'
#
# Generated by Vivado on Wed Jun 16 22:24:18 CEST 2021
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
   "${origin_dir}/../Sources/ip/proc_common_v3_00_a/proc_common_pkg.vhd" \
   "${origin_dir}/../Sources/ip/proc_common_v3_00_a/family_support.vhd" \
   "${origin_dir}/../Sources/ip/proc_common_v3_00_a/pselect_f.vhd" \
   "${origin_dir}/../Sources/ip/proc_common_v3_00_a/ipif_pkg.vhd" \
   "${origin_dir}/../Sources/ip/proc_common_v3_00_a/counter_f.vhd" \
   "${origin_dir}/../Sources/ip/axi_lite_ipif_v1_01_a/address_decoder.vhd" \
   "${origin_dir}/../Sources/ip/axi_lite_ipif_v1_01_a/slave_attachment.vhd" \
   "${origin_dir}/../Sources/ip/axi_lite_ipif_v1_01_a/axi_lite_ipif.vhd" \
   "${origin_dir}/../Sources/hdl/top/fourier_transform_v1_0.vhd" \
   "${origin_dir}/../Sources/hdl/top/fourier_transform_v1_0_user_logic.vhd" \
   "${origin_dir}/../Sources/hdl/top/zcu102_wrapper.vhd" \
   "${origin_dir}/../Sources/xdc/pin_zcu102.xdc" \
  ]
  foreach ifile $files {
  ...
  set files [list \
   "/media/soc/Volume/DFX_Tutorial/dfx_ip_cores/Sources/hdl/xfft/ip/fft_0/fft_0.xci" \
   "/media/soc/Volume/DFX_Tutorial/dfx_ip_cores/Sources/hdl/xfft/xfft_wrapper.vhd" \
  ]
  foreach ifile $files {
    if { ![file isfile $ifile] } {
  ...
  set paths [list \
   [file normalize "$origin_dir/../Sources/ip"] \
  ]
  foreach ipath $paths {
...
set _xil_proj_name_ "dfx_ip_cores"
...
# Create project
create_project ${_xil_proj_name_} ./project_1 -part xczu9eg-ffvb1156-2-e
...
set obj [get_filesets sources_1]
set files [list \
 [file normalize "${origin_dir}/../Sources/hdl/xfft/ip/fft_0/fft_0.xci"] \
 [file normalize "${origin_dir}/../Sources/hdl/xfft/xfft_wrapper.vhd"] \
]
add_files -norecurse -fileset $obj $files

# Import local files from the original project
set files [list \
 [file normalize "${origin_dir}/../Sources/ip/proc_common_v3_00_a/proc_common_pkg.vhd"]\
 [file normalize "${origin_dir}/../Sources/ip/proc_common_v3_00_a/family_support.vhd"]\
 [file normalize "${origin_dir}/../Sources/ip/proc_common_v3_00_a/pselect_f.vhd"]\
 [file normalize "${origin_dir}/../Sources/ip/proc_common_v3_00_a/ipif_pkg.vhd"]\
 [file normalize "${origin_dir}/../Sources/ip/proc_common_v3_00_a/counter_f.vhd"]\
 [file normalize "${origin_dir}/../Sources/ip/axi_lite_ipif_v1_01_a/address_decoder.vhd"]\
 [file normalize "${origin_dir}/../Sources/ip/axi_lite_ipif_v1_01_a/slave_attachment.vhd"]\
 [file normalize "${origin_dir}/../Sources/ip/axi_lite_ipif_v1_01_a/axi_lite_ipif.vhd"]\
 [file normalize "${origin_dir}/../Sources/hdl/top/zcu102_wrapper.vhd"]\
 [file normalize "${origin_dir}/../Sources/hdl/top/fourier_transform_v1_0.vhd"]\
 [file normalize "${origin_dir}/../Sources/hdl/top/fourier_transform_v1_0_user_logic.vhd"]\
]
set imported_files [import_files -fileset sources_1 $files]

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/../Sources/hdl/xfft/ip/fft_0/fft_0.xci"
...
set file "$origin_dir/../Sources/hdl/xfft/xfft_wrapper.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
set file "top/fourier_transform_v1_0.vhd"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "top/fourier_transform_v1_0_user_logic.vhd"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "top/zcu102_wrapper.vhd"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
...
set file "hdl/top/zcu102_wrapper.vhd"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "hdl/top/fourier_transform_v1_0.vhd"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "hdl/top/fourier_transform_v1_0_user_logic.vhd"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
...
set file "[file normalize "$origin_dir/../Sources/xdc/pin_zcu102.xdc"]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "xdc/pin_zcu102.xdc"
...
proc create_hier_cell_zynq_us_ss_0 { parentCell nameHier } {
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {M07_AXI} \
 ] $s_axi_aclk
  ...
  set_property -dict [ list \
   CONFIG.FREQ_HZ {99990005} \
 ] [get_bd_intf_pins /blake2b_0/S_AXI]
 
    set_property -dict [ list \
   CONFIG.FREQ_HZ {99990005} \
 ] [get_bd_pins /blake2b_0/S_AXI_ACLK]
  ...
  set_property -dict [ list \
   CONFIG.FREQ_HZ {99990005} \
 ] [get_bd_pins /myled_0/S_AXI_ACLK]
  ...
  assign_bd_address -offset 0x94000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_us_ss_0/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs M07_AXI/Reg] -force
  assign_bd_address -offset 0x88000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_us_ss_0/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs blake2b_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x90000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_us_ss_0/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs myled_0/S_AXI/myled_0] -force
